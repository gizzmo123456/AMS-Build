...
def create_ssl_socket_wrapper(cert_filepath, key_filepath, ca_bundle_filepath):
    ...
    ssl_socket = ssl.SSLContext( ssl.PROTOCOL_TLS_SERVER ) # ssl.create_default_context( purpose=ssl.Purpose.CLIENT_AUTH, cafile=ca_bundle_filepath ) # ssl.SSLContext( ssl.PROTOCOL_TLS_SERVER )
