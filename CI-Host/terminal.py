...
class Terminal:
    ...
    def read(self):
        ...
        if self.remove_color_formats:
            ...
            output = re.sub( r'(\[[0-9]*)', '', output ) # TODO: this is major improvment. But this will do for git at least. See https://misc.flogisoft.com/bash/tip_colors_and_formatting
            _print( output, "=====", "=====\n", "\n", matches )
