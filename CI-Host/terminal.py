...
class Terminal:
    ...
    def read(self):
        ...
        if self.remove_color_formats:
            ...
            matches = re.findall( r'(\[[0-9]*m)', output, flags=re.UNICODE )
            output = re.sub( r'(\[{2}[0-9]*m)', '', output, flags=re.UNICODE ) # TODO: this is major improvment. But this will do for git at least. See https://misc.flogisoft.com/bash/tip_colors_and_formatting
            _print( output, "=====", "=====\n", "\n", matches )
